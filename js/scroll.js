function renderBurger(){
    ...
    for(let i = 0; i < card.dish.length;i++){
        ...
        catalog.innerHTML += ` <li class="list-unstyled col buttons"><button  class="menu-link-${i} open-but search btn-hover color-10"><a href="resept.html?i=${i}?y=${search.get(`i`)}" class="text-decoration-none color_car font-size-list">${cardItem.name_d}</a></button></li>`
    }
